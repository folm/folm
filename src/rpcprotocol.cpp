...
/**
 * JSON-RPC protocol.  Folm speaks version 1.0 for maximum compatibility,
...
string JSONRPCRequest(const string& strMethod, const UniUniValue& params, const UniValue& id)
{
