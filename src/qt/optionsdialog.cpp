    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("FOLM-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("FOLM-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("FOLM-light"), QVariant("light"));
    ui->theme->addItem(QString("FOLM-traditional"), QVariant("trad"));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->anonymizeFolm, OptionsModel::AnonymizeFolmAmount);
