...
unsigned int static DarkGravityWave(const CBlockIndex* pindexLast, const Consensus::Params& param)
{
    ...
    if (BlockLastSolved == NULL || BlockLastSolved->nHeight == 0 || BlockLastSolved->nHeight < PastBlocksMin) {
        return PUintToArith256(params.powLimit).GetCompact();
    }
    ...
    int64_t _nTargetTimespan = CountBlocks * (pindexLast->nHeight > 499 ? params.nPowTargetSpacing :params.nPowTargetSpacingSlowLaunch);
