...
Clone the git repositories for folm and Gitian.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/folmpay/folm
```
...
in the folm repository under 'Fetch and build inputs' to install sources which require
...
To build Folm (for Linux, OS X and Windows) just follow the steps under 'perform
Gitian builds' in [doc/release-process.md](release-process.md#perform-gitian-builds) in the folm repository.
...
```bash
    ...
    From https://github.com/folmpay/folm
...
[folm/gitian.sigs](https://github.com/folmpay/gitian.sigs/) repository, or if that's not possible to create a pull
request.
