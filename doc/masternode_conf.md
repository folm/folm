 ...
 * Windows: %APPDATA%\Folm\
 * Mac OS: ~/Library/Application Support/Folm/
 * Unix/Linux: ~/.folm/
...
* the collateral for `mn1` is output `0` of transaction http://test.explorer.folm.fr/tx/2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c and it has amount of 1000 FOLM
...
When using remote masternode setup, you **must** remove `masternode=1` from local `folm.conf` file if you had it there in previous versions. This option should be used only to start local Hot masternode now.
