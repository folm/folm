...
In order to support loading of multiple wallets in folm-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is folm.cpp.
...
Changes to folm.cpp
----------------------
folm.cpp is the entry point into folm-qt, and as such, will require some minor modifications to provide hooks for
